...
public class VisualPreferences extends Fragment implements OnChartValueSelectedListener{
    ...
    protected int color;
    protected String categoryPosition;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        categoryPosition=getArguments().getString("position","");
    ...
    protected Map<String, Set<String>> getCategoriesHistograms(){
    ...
    public void updateChart(){
        ...
        /*
        if(mainActivity!=null) {
            List<Map<String, Set<String>>> categoriesHistograms=getCategoriesHistograms();
